            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        ...
                        <p>joaovitorfespindola@gmail.com</p>
                        <p>(48) 99169-3710</p>
                        <p>+55, Brasil </p>
                        <hr className="w-50 mx-auto" />
                        <ul className="list-unstyled d-flex justify-content-center">
                            <li>
                                <a href="https://www.instagram.com/joaovfe/">
                            ...
                            <li className="mx-2">
                                <a href="https://github.com/joaovfe">
                            ...
                            <li className="me-2">
                                <a href="https://www.linkedin.com/in/jo%C3%A3o-vitor-figueiredo-espindola-3605102a4/">
